...
\begin{table}[!t]
	\processtable{PLACEHOLDER -- table enlisting high-throughput molecular assays.
	\label{tab:geoSamples}} {\begin{tabular}{@{}llll@{}}\toprule 
			Biological relation? & Data layer &  \\ \midrule
			- &            Genome &          -  \\ \botrule
	\end{tabular}}{This is a footnote}
\end{table}
