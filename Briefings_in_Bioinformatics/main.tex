...
A regularly cited fact that the exome, i.e. protein-coding part of the genome, harbors 85\% of the diease-causing variants turns out to be an outdated estimate from 1995 \cite{Antonarakis:2001:nature}. Our survey of the variants having significant association with human traits, as compiled by GWAS (to limit to association with p-value less than $10^{-5}$), revealed a large fraction in non-protein coding regions such as intron, interngenic, 5'-UTR, 3'-UTR, etc (Figure \ref{fig:variant_context}). Notably, the distribution of CVD-associated variants in the genome mimic that of the complete set of variants. This observation emphasizes the fact that our understanding of CVD as well as biology in general has been critically limited by our technical capability to characterize protein-coding genes. More recent findings have unraveled a larger role of non-coding RNAs and epigenetics in cardiovascular biology.
