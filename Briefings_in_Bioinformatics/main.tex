...
The queries are based on indexing with Medical Subject Heading (MeSH) Terms to avoid counting irrelevant publications. (The MeSH Database entry for \textit{cardiovascular diseases} includes many types of cardiovascular abnormalities which may occur in organs other than the circulatory system.)
%{https://www.ncbi.nlm.nih.gov/mesh/68002318} 


\section{Complexity of CVD}

\todo{Elaborate on these aspects: polygenic diseases, missing heritability, gene-environment interactions... Some may be overlapping.}
