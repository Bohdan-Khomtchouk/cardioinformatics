...
\subsubsection*{Beyond genetics: epigenetics and the gene-environment interplay}	
	...
	Cardioinformatics, while benefiting from two decades of research in bioinformatics, has its own challenges in dealing with complex cardiovascular disease data.
...
{\begin{tabular}{l l l}
	...
	\subsection*{Security of private data}
	...
	\subsubsection{Leveraging human learning}
