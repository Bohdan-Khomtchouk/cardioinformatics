...
{\begin{tabular}{l l l}
	...
	%%%%%% perspective
Bioinformatics is more than a powerful toolkit for cardiovascular research. Important perspectives have arisen from the application of computational methodology. For example, when thousand of loci were found to involve in a single disease, the paradigm shifted from additive effect of multiple-genes to the interactions between them, turning the focus from physical genes to the "eigengenes" that represent biologically functional module \citep{Weiss:2012:Good}. The ability to view on biological system as a whole underlies the success of pharmacogenomics, because one can focus on whether a drug can mimic the healthy state or disrupt it, without the mechanistic knowledge of individual actors and their interactions. On the other hand, such approach is helpful to study a system by ways of its response to external stimuli.
