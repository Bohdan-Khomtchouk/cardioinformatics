...
queries <- c('cardiovascular diseases' = '"cardiovascular diseases"[MeSH Major Topic]',
             'bioinformatics' = 'bioinformatics[Other Term] OR genomics[MeSH Terms]',
             'cardioinformatics' = '(bioinformatics[Other Term] OR genomics[MeSH Terms]) AND ("cardiovascular diseases"[MeSH Major Topic])',
...
cardio_gsm <- dbGetQuery(con, paste('SELECT gsm.gsm, gsm.source_name_ch1, gsm.organism_ch1, organism_ch2, gpl.gpl, gpl.title as platform, gpl.description as platform_description, technology, gse.gse, gse.submission_date, gse.pubmed_id, gse.title, gse.summary',
                      'FROM gse ',
